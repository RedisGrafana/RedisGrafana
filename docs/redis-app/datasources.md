...
Redis Application plug-in helps to manage Redis Data Sources and allows to open [CLI](dashboards.md#cli-command-line-interface) and [RedisGears](dashboards.md#redisgears) dashboards for specific data source.
